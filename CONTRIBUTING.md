...
## Public participation is comments-only
...
- Incorporated minor feedback is credited in acknowledgments; major changes are reflected in release notes and version bumps.
- For sensitive or abuse-related reports, clearly flag them in your comment so moderators can route them appropriately.

## Reviews for published essays
- Any PR that touches files under `site/essays/published/**` requires approval from @noahvandongen before it can merge.
